...
namespace Rewired.Demos
{
    ...
    {
        [Tooltip("Should the hardware pointer be hidden?")] [SerializeField]
        ...
        public void OnScreenPositionChanged(Vector2 screenPosition) {
            ...
            Vector2 point;
            RectTransformUtility.ScreenPointToLocalPointInRectangle((transform.parent as RectTransform), screenPosition,
                                                                    camera, out point);
