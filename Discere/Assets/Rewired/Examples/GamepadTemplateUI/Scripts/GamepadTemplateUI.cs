...
namespace Rewired.Demos.GamepadTemplateUI
{
    ...
    public class GamepadTemplateUI : MonoBehaviour
    {
        ...
        [SerializeField] private ControllerUIElement leftStickX;
        [SerializeField] private ControllerUIElement leftStickY;
        [SerializeField] private ControllerUIElement leftStickButton;
        [SerializeField] private ControllerUIElement rightStickX;
        [SerializeField] private ControllerUIElement rightStickY;
        [SerializeField] private ControllerUIElement rightStickButton;
        [SerializeField] private ControllerUIElement actionBottomRow1;
        [SerializeField] private ControllerUIElement actionBottomRow2;
        [SerializeField] private ControllerUIElement actionBottomRow3;
        [SerializeField] private ControllerUIElement actionTopRow1;
        [SerializeField] private ControllerUIElement actionTopRow2;
        [SerializeField] private ControllerUIElement actionTopRow3;
        [SerializeField] private ControllerUIElement leftShoulder;
        [SerializeField] private ControllerUIElement leftTrigger;
        [SerializeField] private ControllerUIElement rightShoulder;
        [SerializeField] private ControllerUIElement rightTrigger;
        [SerializeField] private ControllerUIElement center1;
        [SerializeField] private ControllerUIElement center2;
        [SerializeField] private ControllerUIElement center3;
        [SerializeField] private ControllerUIElement dPadUp;
        [SerializeField] private ControllerUIElement dPadRight;
        [SerializeField] private ControllerUIElement dPadDown;
        [SerializeField] private ControllerUIElement dPadLeft;
        ...
        private Player player {
            get { return ReInput.players.GetPlayer(playerId); }
        }
        ...
        private void Awake() {
            ...
            _uiElementsArray = new UIElement[] {
                                                   ...
                                                   new UIElement(GamepadTemplate.elementId_leftStickButton,
                                                                 leftStickButton),
                                                   ...
                                                   new UIElement(GamepadTemplate.elementId_rightStickButton,
                                                                 rightStickButton),
                                                   new UIElement(GamepadTemplate.elementId_actionBottomRow1,
                                                                 actionBottomRow1),
                                                   new UIElement(GamepadTemplate.elementId_actionBottomRow2,
                                                                 actionBottomRow2),
                                                   new UIElement(GamepadTemplate.elementId_actionBottomRow3,
                                                                 actionBottomRow3),
                                                   new UIElement(GamepadTemplate.elementId_actionTopRow1,
                                                                 actionTopRow1),
                                                   new UIElement(GamepadTemplate.elementId_actionTopRow2,
                                                                 actionTopRow2),
                                                   new UIElement(GamepadTemplate.elementId_actionTopRow3,
                                                                 actionTopRow3),
                                                   ...
                                                   new UIElement(GamepadTemplate.elementId_rightShoulder1,
                                                                 rightShoulder),
            ...
            _sticks = new Stick[] {
                                      new Stick(leftStick, GamepadTemplate.elementId_leftStickX,
                                                GamepadTemplate.elementId_leftStickY),
                                      new Stick(rightStick, GamepadTemplate.elementId_rightStickX,
        ...
        private class Stick
        {
            ...
            public Vector2 position {
                get { return _transform != null ? _transform.anchoredPosition - _origPosition : Vector2.zero; }
                set {
